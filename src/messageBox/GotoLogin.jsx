...
const GotoLogin = ({ isOpen, onConfirm, onCancel, message }) => {
  ...
  return (
    <div>
      <Modal open={isOpen} onClose={handleCancelClick}>
        <div
          className="flex flex-col w-1/2 bg-white justify-center items-center absolute top-1/2 left-1/2 gap-y-2 rounded-lg border p-8"
          style={{
